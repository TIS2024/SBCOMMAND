...
//    }
    ...
    public void write(double slow) {
        robot.dtFrontLeftMotor.setPower(ws[0] * slow);
        robot.dtFrontRightMotor.setPower(ws[1] * slow);
        robot.dtBackLeftMotor.setPower(ws[2] * slow);
        robot.dtBackRightMotor.setPower(ws[3] * slow);
    }
